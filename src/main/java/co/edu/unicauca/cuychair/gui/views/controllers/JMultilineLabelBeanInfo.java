 ...
 * @author Frdy
 */
public class JMultilineLabelBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_mixingCutoutShape = 86;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_actions] = new PropertyDescriptor ( "actions", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getActions", null ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_caret] = new PropertyDescriptor ( "caret", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getCaret", "setCaret" ); // NOI18N
            properties[PROPERTY_caretColor] = new PropertyDescriptor ( "caretColor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getCaretColor", "setCaretColor" ); // NOI18N
            properties[PROPERTY_caretListeners] = new PropertyDescriptor ( "caretListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getCaretListeners", null ); // NOI18N
            properties[PROPERTY_caretPosition] = new PropertyDescriptor ( "caretPosition", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getCaretPosition", "setCaretPosition" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_columns] = new PropertyDescriptor ( "columns", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getColumns", "setColumns" ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledTextColor] = new PropertyDescriptor ( "disabledTextColor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDisabledTextColor", "setDisabledTextColor" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_document] = new PropertyDescriptor ( "document", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDocument", "setDocument" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dragEnabled] = new PropertyDescriptor ( "dragEnabled", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDragEnabled", "setDragEnabled" ); // NOI18N
            properties[PROPERTY_dropLocation] = new PropertyDescriptor ( "dropLocation", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDropLocation", null ); // NOI18N
            properties[PROPERTY_dropMode] = new PropertyDescriptor ( "dropMode", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDropMode", "setDropMode" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusAccelerator] = new PropertyDescriptor ( "focusAccelerator", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFocusAccelerator", "setFocusAccelerator" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_highlighter] = new PropertyDescriptor ( "highlighter", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getHighlighter", "setHighlighter" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_keymap] = new PropertyDescriptor ( "keymap", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getKeymap", "setKeymap" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_lineCount] = new PropertyDescriptor ( "lineCount", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLineCount", null ); // NOI18N
            properties[PROPERTY_lineEndOffset] = new IndexedPropertyDescriptor ( "lineEndOffset", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, null, "getLineEndOffset", null ); // NOI18N
            properties[PROPERTY_lineOfOffset] = new IndexedPropertyDescriptor ( "lineOfOffset", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, null, "getLineOfOffset", null ); // NOI18N
            properties[PROPERTY_lineStartOffset] = new IndexedPropertyDescriptor ( "lineStartOffset", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, null, "getLineStartOffset", null ); // NOI18N
            properties[PROPERTY_lineWrap] = new PropertyDescriptor ( "lineWrap", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLineWrap", "setLineWrap" ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_margin] = new PropertyDescriptor ( "margin", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMargin", "setMargin" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_navigationFilter] = new PropertyDescriptor ( "navigationFilter", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getNavigationFilter", "setNavigationFilter" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredScrollableViewportSize] = new PropertyDescriptor ( "preferredScrollableViewportSize", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getPreferredScrollableViewportSize", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_rows] = new PropertyDescriptor ( "rows", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getRows", "setRows" ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportHeight] = new PropertyDescriptor ( "scrollableTracksViewportHeight", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getScrollableTracksViewportHeight", null ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportWidth] = new PropertyDescriptor ( "scrollableTracksViewportWidth", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getScrollableTracksViewportWidth", null ); // NOI18N
            properties[PROPERTY_selectedText] = new PropertyDescriptor ( "selectedText", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSelectedText", null ); // NOI18N
            properties[PROPERTY_selectedTextColor] = new PropertyDescriptor ( "selectedTextColor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSelectedTextColor", "setSelectedTextColor" ); // NOI18N
            properties[PROPERTY_selectionColor] = new PropertyDescriptor ( "selectionColor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSelectionColor", "setSelectionColor" ); // NOI18N
            properties[PROPERTY_selectionEnd] = new PropertyDescriptor ( "selectionEnd", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSelectionEnd", "setSelectionEnd" ); // NOI18N
            properties[PROPERTY_selectionStart] = new PropertyDescriptor ( "selectionStart", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSelectionStart", "setSelectionStart" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_tabSize] = new PropertyDescriptor ( "tabSize", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getTabSize", "setTabSize" ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_wrapStyleWord] = new PropertyDescriptor ( "wrapStyleWord", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getWrapStyleWord", "setWrapStyleWord" ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_caretListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "caretListener", javax.swing.event.CaretListener.class, new String[] {"caretUpdate"}, "addCaretListener", "removeCaretListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( co.edu.unicauca.cuychair.gui.views.controllers.JMultilineLabel.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_modelToView2D96 = 96;
    ...
    private static final int METHOD_scrollRectToVisible151 = 151;
    private static final int METHOD_select152 = 152;
    private static final int METHOD_selectAll153 = 153;
    private static final int METHOD_setBounds154 = 154;
    private static final int METHOD_setComponentZOrder155 = 155;
    private static final int METHOD_setDefaultLocale156 = 156;
    ...
    private static final int METHOD_viewToModel2D170 = 170;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_modelToView2D96] = new MethodDescriptor(javax.swing.text.JTextComponent.class.getMethod("modelToView2D", new Class[] {int.class})); // NOI18N
            methods[METHOD_modelToView2D96].setDisplayName ( "" );
            ...
            methods[METHOD_requestFocus141] = new MethodDescriptor(java.awt.Component.class.getMethod("requestFocus", new Class[] {java.awt.event.FocusEvent.Cause.class})); // NOI18N
            ...
            methods[METHOD_requestFocusInWindow144] = new MethodDescriptor(java.awt.Component.class.getMethod("requestFocusInWindow", new Class[] {java.awt.event.FocusEvent.Cause.class})); // NOI18N
            ...
            methods[METHOD_scrollRectToVisible151] = new MethodDescriptor(javax.swing.JComponent.class.getMethod("scrollRectToVisible", new Class[] {java.awt.Rectangle.class})); // NOI18N
            methods[METHOD_scrollRectToVisible151].setDisplayName ( "" );
            methods[METHOD_select152] = new MethodDescriptor(javax.swing.text.JTextComponent.class.getMethod("select", new Class[] {int.class, int.class})); // NOI18N
            methods[METHOD_select152].setDisplayName ( "" );
            methods[METHOD_selectAll153] = new MethodDescriptor(javax.swing.text.JTextComponent.class.getMethod("selectAll", new Class[] {})); // NOI18N
            methods[METHOD_selectAll153].setDisplayName ( "" );
            methods[METHOD_setBounds154] = new MethodDescriptor(java.awt.Component.class.getMethod("setBounds", new Class[] {int.class, int.class, int.class, int.class})); // NOI18N
            methods[METHOD_setBounds154].setDisplayName ( "" );
            methods[METHOD_setComponentZOrder155] = new MethodDescriptor(java.awt.Container.class.getMethod("setComponentZOrder", new Class[] {java.awt.Component.class, int.class})); // NOI18N
            methods[METHOD_setComponentZOrder155].setDisplayName ( "" );
            methods[METHOD_setDefaultLocale156] = new MethodDescriptor(javax.swing.JComponent.class.getMethod("setDefaultLocale", new Class[] {java.util.Locale.class})); // NOI18N
            methods[METHOD_setDefaultLocale156].setDisplayName ( "" );
            ...
            methods[METHOD_viewToModel2D170] = new MethodDescriptor(javax.swing.text.JTextComponent.class.getMethod("viewToModel2D", new Class[] {java.awt.geom.Point2D.class})); // NOI18N
            methods[METHOD_viewToModel2D170].setDisplayName ( "" );
